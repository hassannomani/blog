        ...
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                <article class="hentry post post-standard-details">
                    ...
                    <img src="{{ $post->featured }}" alt="{{$post->slug}}">
                    </div>
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-content">
                        <div class="author-info">
                            <h5 class="author-name">{{ $post->user->name }}</h5><br>
                ...
                <div class="pagination-arrow">
                    ...
                    @if($next)
                        <a href="{{route('post.single',['slug'=>$next->slug])}}" class="btn-next-wrap">
                            <div class="btn-content">
                                ...
                                <p class="btn-content-subtitle">{{ $next->slug }}</p>
                            </div>
                            <svg class="btn-next">
                    ...
                    @if($prev)
                        <a href="{{route('post.single',['slug'=>$prev->slug])}}" class="btn-prev-wrap">
                            ...
                            <p class="btn-content-subtitle">{{ $prev->slug }}</p>
                            </div>
                        </a>
                    @endif
